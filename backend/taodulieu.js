// Hàm dùng để tạo dữ liệu chấm công mẫu cho nhân viên 
const fs = require('fs');
...
for (let d = new Date(startDate); d <= endDate; d.setDate(d.getDate() + 1)) {
    ...
    employees.forEach(emp => {
        ...
        if (rand < 0.60) {
            ...
            // 3% Đúng giờ và Tăng ca (Max OT) (Vào 07:45-07:59 | Ra 20:00-21:30)
            hVao = 7; mVao = ranMin(45, 59);
            ...
            // 1% Đi trễ và Tăng ca (Max OT) (Vào 08:05-08:20 | Ra 20:00-21:00)
            hVao = 8; mVao = ranMin(5, 20);
